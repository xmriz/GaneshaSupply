...
const main = async () => {
  await clearData();
  await createProduct("Pen", 3000, "This is a pen, you can write with it.", "https://img.freepik.com/premium-photo/white-pen-marble-background-luxury-stationery-business-brand_360074-52942.jpg?w=2000");
